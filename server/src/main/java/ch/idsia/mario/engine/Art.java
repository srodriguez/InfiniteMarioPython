...
public class Art {
    ...
    private static Image getImage(GraphicsConfiguration gc, String imageName)
        ...
        Image image = gc.createCompatibleImage(
                source.getWidth(), source.getHeight(), Transparency.BITMASK);
    ...
    private static Image[][] cutImage(GraphicsConfiguration gc, String imageName,
            int xSize, int ySize) throws IOException {
