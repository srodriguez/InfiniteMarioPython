...
public class MainRun {
    ...
    public static void createAgentsPool() {
        if (!calledBefore) {
            ...
            // available for the framework. All created agents by now are used here.
            // They can be accessed by just setting the commandline property -ag to
            // the name of desired agent.
            calledBefore = true;
            // addAgentToThePool
    ...
    public static double testConfig(TimingAgent controller,
            ...
            int levelDifficulty, boolean paused) {
    ...
    public static StatisticalSummary test(Agent controller,
        ...
        for (int i = 0; i < numberOfTrials; i++) {
            ...
            // System.out.println("result.marioMode = " +
            // result.marioMode); System.out.println("result.marioStatus =
            // " + result.marioStatus);
